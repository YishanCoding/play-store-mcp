...
class PlayStoreClient:
    ...
    def get_crash_rate(
        ...
        return self._query_metric_set(
            ...
            metrics=["crashRate", "crashRate7dUserWeighted", "crashRate28dUserWeighted", "userPerceivedCrashRate", "userPerceivedCrashRate7dUserWeighted", "userPerceivedCrashRate28dUserWeighted", "distinctUsers"],
